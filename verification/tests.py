...
TESTS = {
    ...
    "Extra": list(make_tests(
        ...
        ('ABCDEFKLMNOPUVWXY ABCDEFKMNOPTUVWXY ABCDFJKLMNPTUVWXY', 52,
         [[0, 4, 4], [0, 4, 3], [0, 4, 2], [0, 4, 1], [0, 4, 0], [1, 4, 4], [1, 4, 2], [1, 4, 0], [2, 4, 4], [2, 4, 2],
          [2, 4, 0], [3, 4, 4], [3, 4, 2], [3, 4, 0], [4, 4, 3], [4, 4, 1], [4, 4, 0], [0, 3, 0], [0, 2, 4], [0, 2, 3],
          [0, 2, 2], [0, 2, 0], [1, 2, 4], [1, 2, 2], [1, 2, 0], [2, 2, 4], [2, 2, 2], [2, 2, 0], [3, 2, 4], [3, 2, 2],
          [3, 2, 0], [4, 2, 3], [4, 2, 0], [0, 1, 4], [0, 1, 0], [0, 0, 4], [0, 0, 3], [0, 0, 2], [0, 0, 1], [0, 0, 0],
          [1, 0, 4], [1, 0, 2], [1, 0, 0], [2, 0, 4], [2, 0, 2], [2, 0, 0], [3, 0, 4], [3, 0, 2], [3, 0, 0], [4, 0, 3],
          [4, 0, 1], [4, 0, 0]]),
    ))
}
